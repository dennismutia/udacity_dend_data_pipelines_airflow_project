...
class LoadDimensionOperator(BaseOperator):
    '''
    Loads data from staging table to target dimension table
    
    Parameters
    redshift_conn_id    :   Redshift connection ID
    table               :   Target table name
    select_sql          :   sql query to laod data from staging table to target table
    append_insert       :   option to append or truncate data during insert
